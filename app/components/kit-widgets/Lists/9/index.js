...
class List9 extends React.Component {
  render() {
    return (
      <div>
        <ul className="list-unstyled">
          ...
          <li className={style.item}>
            ...
            <div>
              <div>
                <strong className="text-primary">Litecoint</strong> lorem Ipsum
          ...
          <li className={style.item}>
            ...
            <div>
              <div>
                <strong>Litecoin</strong> lorem Ipsum is simply dummy text of
                the printing and...
              </div>
              <div className="text-muted">Deposited by PayPal</div>
            </div>
